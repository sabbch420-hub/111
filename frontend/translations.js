(function () {
  ...
  const translations = {
    fr: {
      ...
      confirm_return_object: "Voulez-vous vraiment rendre l'objet {name} ?",
...
reset_error_update: "Impossible de mettre à jour le mot de passe.",
    ...
    en: {
      ...
      confirm_return_object: "Do you really want to return object {name}?",
...
reset_error_update: "Unable to update password.",
    ...
    ar: {
      ...
      confirm_return_object: "هل تريد فعلاً إرجاع الجهاز {name}؟",
